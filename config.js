...
export const ITEMS = [
    ...
    // 武器
        ...
        { id: 'w3', name: '龍牙戰斧', type: 'weapon', attack: 15, value: 100, price: 800, rarity: 3 , intro: '屠龍戰士曾使用過的斧頭'},
        ...
        { id: 'w6', name: '刺客短匕', type: 'weapon', attack: 25, value: 230, price: 400, rarity: 3, intro: '暗殺者常用的匕首'},
        { id: 'w7', name: '騎士槍盾', type: 'weapon', attack: 25, defense: 25, value: 320, price: 580, rarity: 4, intro: '舊城邦騎士的套裝'},
        { id: 'w8', name: '澄澈之鋒刃', type: 'weapon', attack: 75, value: 520, price: 1220, rarity: 5 ,intro: '刀刃澄澈可透光的冰晶刀'},
        { id: 'w9', name: '冰晶樹節枝', type: 'weapon', attack: 85, value: 620, price: 1420, rarity: 6 ,intro: '用冰晶樹的樹枝加工而成的武器'},
        { id: 'w10', name: '魔影之爪', type: 'weapon', attack: 155, defense: -40, value: 620, price: 1420, rarity: 7, intro: '暗影惡魔的爪子'},
        { id: 'w11', name: '嵐切', type: 'weapon', attack: 50, value: 340, price: 1500, rarity: 8, intro: '御風劍士的寶刀'},
